...
public class MultiRandomForest {
    ...
    public static void main(String[] args) {
        ...
        int batchSize = (args.length >= 13) ? Integer.parseInt(args[12]) : DEFAULT_NUM_RF;
        ...
        for (int i = 1; i <= numRF; ++i) {
            ...
            RandomForest.generateRandomModelWithTest(numSamples, numFeatures, numClasses, numInformative, numRedundant,
                numRepeated, numClustersPerClass, shuffle, randomState, numEstimators, numEstimators, numModels, batchSize);
        }
